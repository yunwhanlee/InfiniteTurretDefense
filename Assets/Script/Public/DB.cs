...
public class DB : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        userCharaDataArr = new UserCharaData[] {
            new (CHR_CATE.ARCHER, CHR_GRADE.NORMAL, 99, CHR_PLACE.CENTER, new int[SKILL_CNT] {1,0,0,0,0,0,0}),
            new (CHR_CATE.WARRIOR, CHR_GRADE.NORMAL, 99, CHR_PLACE.NONE, new int[SKILL_CNT] {1,0,0,0,0,0,0})
        };
    }
