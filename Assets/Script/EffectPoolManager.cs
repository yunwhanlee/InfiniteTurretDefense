...
public class EffectPoolManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        poolDics.Add(EF_IDX.PowerStrikeEF, Init(powerStrikeEF.gameObject, 20));
        // 여기에 추가
    }
...
#region POOL
    ...
    /// <summary> 오브젝트 풀링리스트 대기회수 </summary>
    public IEnumerator CoReleasePoolDics(EF_IDX enumIdx, GameObject obj)
    {
